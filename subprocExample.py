...
subprocess.call(['ls', '-a', '/bin/*.c'], shell=True) # linux/MacOS

# Command with shell expansion
subprocess.call('echo %PATH%', shell=True) # os.environ["PATH"] # Windows

# Capturing Output
output = subprocess.check_output(['ls', '-l']) # linux/MacOS
output = subprocess.check_output(['dir', '/all']) # windows
